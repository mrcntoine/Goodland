...
const url =
  "https://goodland-1.s3.ca-central-1.amazonaws.com/tech-dropdown-updated.json";
        ...
        $.each(response, function (key, entry) {
          $("#results").append(
            '<div class="item" data-value="' +
              ...
              '" data-logo="' +
              entry.logo +
              '"><img style="width:20px; height:auto; margin-top: 0;" src="' +
              entry.logo +
              '">' +
              entry.name +
              "</div>"
...
$("#multi-select-tech-1").dropdown({ maxSelections: 5 });

$("#multi-select-tech-2").dropdown({ maxSelections: 5 });
...
$("#poste-1").dropdown();
$("#poste-2").dropdown();
$("#select-niveau-2").dropdown();
$("#select-niveau-3").dropdown();
$("#select-niveau-4").dropdown();
$("#select-experiences").dropdown();
$("#select-experiences-1").dropdown();
$("#select-experiences-2").dropdown();
$("#select-experiences-3").dropdown();
$("#select-experiences-4").dropdown();
...
$.fn.form.settings.rules.squillvalidation3 = function (value) {
  ...
  if (
    (editor3.getContents()["ops"] || []).length !== 1 ||
    editor3.getText().trim().length === 0
  ) {
...
$.fn.form.settings.rules.squillvalidation4 = function (value) {
  ...
  if (
    (editor4.getContents()["ops"] || []).length !== 1 ||
    editor4.getText().trim().length === 0
  ) {
